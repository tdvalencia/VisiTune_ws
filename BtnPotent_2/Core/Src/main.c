...
uint8_t pause_state  = 0;   // 0 = unpaused, 1 = paused
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : REWIND_Pin PAUSE_Pin FORWARD_Pin */
  GPIO_InitStruct.Pin = REWIND_Pin|PAUSE_Pin|FORWARD_Pin;
